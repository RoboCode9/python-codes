...
class AlienInvasion:
    ...
    def _check_keydown_events(self, event):
        ...
        elif event.key == pygame.K_z: #change 2
            sys.exit()
    ...
    def _update_circles(self):
        #change 4 "Code for colored circles"
        for i in range(100):
            x = random.randint(0, self.settings.screen_width)
            y = random.randint(0, self.settings.screen_height)
            size = random.randint(1, 15)
            color = random.choice([(255, 255, 255), (255,0,0), (255,165,0), (255,255,0), (0,0,255), (255,0,255)]) #white, red, orange, yellow, blue, purple
