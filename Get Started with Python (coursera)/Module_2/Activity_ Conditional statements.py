...
send_email(3, 5)    # Should print 'Not enough visits.'
send_email(5, 5)    # Should print 'Send email.'
send_email(15, 10)  # Should print 'Send email.'
...
send_email(3, 5, 8)   # Should print 'Not enough visits.'
send_email(5, 5, 8)   # Should print 'Send email only.'
send_email(6, 5, 8)   # Should print 'Send email only.'
send_email(8, 5, 8)   # Should print 'Send email with coupon.'
send_email(10, 5, 8)  # Should print 'Send email with coupon.'
